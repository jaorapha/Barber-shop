    ...
    public partial class AgendamentosScreen : Form
    {
        ...
        private void LoadDatabaseData()
        {
            ...
            try
            {
                ...
                string commandString = "SELECT customers.id, scutomers.full_name FROM customers;";

                if (txtbSearch.Text != "")
                {
                    commandString = "SELECT customers.id, customers.full_name FROM customers WHERE full_name LIKE @nome";
                }
                ...
                using (MySqlCommand command = new MySqlCommand(commandString, connection))
                {
                    ...
                    {
                        command.CommandText = "SELECT customers.id, customers.full_name FROM customers;";
                    }
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    MySqlCommand comando = new MySqlCommand("INSERT INTO schedules(customer_id,schedules.service,schedules.horary) values(" + txtId.Text + ",'" + txtCorte.Text + "','" + txtData.Text + "');", conexaoMysql);
